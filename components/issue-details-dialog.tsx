...
import { Issue as PrismaIssue, IssueStatus, IssuePriority } from "@/lib/generated/prisma";

// Extend with the shape actually passed in (assignee/reporter objects for the avatars)
type Issue = PrismaIssue & {
  assignee?: { name?: string | null; imageUrl?: string | null } | null;
  reporter: { clerkUserId?: string | null; name?: string | null; imageUrl?: string | null };
};
